...
const SUBJECT_COLORS = {
  ...
  英語: "bg-purple-100 text-purple-700 border-purple-200",
  外国語: "bg-purple-100 text-purple-700 border-purple-200",
  理科: "bg-green-100 text-green-700 border-green-200",
  社会: "bg-amber-100 text-amber-700 border-amber-200",
...
function CreateTest({ subjects, classes, onSave, onCancel }) {
